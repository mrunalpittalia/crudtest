...
<div class="row g-0 justify-content-center">
    <div class="col-12 col-md-10">
        <div class="card border-0 bg-transparent">
            <form action="{{ route('employee.update', [$employee->employee_id]) }}" class="needs-validation" method="POST" novalidate name="employee_update_form" id="employee_update_form" >
                ...
                <div class="card-body border-0 px-0">
                    <div class="row">
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" id="first_name" name="first_name" value="{{ $employee->first_name }}" />
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" id="last_name" name="last_name" value="{{ $employee->last_name }}" />
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('email_address') ? ' is-invalid' : '' }}" id="email_address" name="email_address" value="{{ $employee->email_address }}" />
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <select class="form-select{{ $errors->has('company_id') ? ' is-invalid' : '' }}" id="company_id" name="company_id" >
                                @foreach ($company_data as $each_company_id=>$each_company_name)
                                    <option value="{{ $each_company_id }}" @if($employee->company_id == $each_company_id){{ ' selected="selected"' }}@endif >{{ $each_company_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('position') ? ' is-invalid' : '' }}" id="position" name="position" value="{{ $employee->position }}" />
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" id="city" name="city" value="{{ $employee->city }}" />
                            @if ($errors->has('city'))
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" id="country" name="country" value="{{ $employee->country }}" />
                            ...
                            <div class="d-block">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="status0" value="0" 
                                        @if($employee->status == 0){{ 'checked="checked"' }}@endif >
                ...
                <div class="card-footer bg-transparent p-0 d-grid gap-1">
                    <button class="btn btn-primary fw-bold border-0 text-white" type="submit" style="outline: none;">
                        {{ trans('messages.employee_edit_form_submit_btn_text') }}
                    </button>
                </div>
                @csrf
            </form>
